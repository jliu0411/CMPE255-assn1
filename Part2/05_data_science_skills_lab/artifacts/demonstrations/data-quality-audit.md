# data-quality-audit demonstration

## Scenario

**Dataset:** Online Retail  
**Kaggle:** `https://www.kaggle.com/datasets/tunguz/online-retail`  
**Objective:** Audit cancellations, returns, duplicate lines and missing identifiers.

## Acquire

```bash
kaggle datasets download -d datasets/tunguz/online-retail
```
...
3. Execute: Audit cancellations, returns, duplicate lines and missing identifiers.
...
The demonstration uses the dataset for transaction quality, basket and business metrics. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

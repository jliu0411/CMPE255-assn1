# analysis-retrospective demonstration

## Scenario

**Dataset:** Titanic — Machine Learning from Disaster  
**Kaggle:** `https://www.kaggle.com/competitions/titanic`  
**Objective:** Review what worked, failed and should be automated after delivery.
...
3. Execute: Review what worked, failed and should be automated after delivery.

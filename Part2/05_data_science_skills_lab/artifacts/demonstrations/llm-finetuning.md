# llm-finetuning demonstration

## Scenario

**Dataset:** arXiv Dataset  
**Kaggle:** `https://www.kaggle.com/datasets/Cornell-University/arxiv`  
**Objective:** Prepare licensed title/abstract instruction pairs for parameter-efficient tuning.

## Acquire

```bash
kaggle datasets download -d datasets/Cornell-University/arxiv
```
...
3. Execute: Prepare licensed title/abstract instruction pairs for parameter-efficient tuning.
...
The demonstration uses the dataset for rag and language-model adaptation. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

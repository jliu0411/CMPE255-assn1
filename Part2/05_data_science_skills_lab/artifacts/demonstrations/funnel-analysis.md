# funnel-analysis demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Measure approval-to-delivery stages and diagnose drop-off.
...
3. Execute: Measure approval-to-delivery stages and diagnose drop-off.

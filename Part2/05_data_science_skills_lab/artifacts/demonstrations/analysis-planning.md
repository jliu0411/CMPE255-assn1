# analysis-planning demonstration

## Scenario

**Dataset:** Rossmann Store Sales  
**Kaggle:** `https://www.kaggle.com/competitions/rossmann-store-sales`  
**Objective:** Frame decisions, hypotheses, data, methods, risks and deliverables.
...
3. Execute: Frame decisions, hypotheses, data, methods, risks and deliverables.

# pytorch-training-loop demonstration

## Scenario

**Dataset:** SMS Spam Collection Dataset  
**Kaggle:** `https://www.kaggle.com/datasets/uciml/sms-spam-collection-dataset`  
**Objective:** Train a compact text classifier with device, AMP, eval and checkpoints.

## Acquire

```bash
kaggle datasets download -d datasets/uciml/sms-spam-collection-dataset
```
...
3. Execute: Train a compact text classifier with device, AMP, eval and checkpoints.
...
The demonstration uses the dataset for text classification and model serving. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

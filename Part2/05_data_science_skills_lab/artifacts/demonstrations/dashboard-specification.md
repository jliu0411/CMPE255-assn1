# dashboard-specification demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Specify executive commerce dashboard metrics, filters and drill paths.
...
3. Execute: Specify executive commerce dashboard metrics, filters and drill paths.

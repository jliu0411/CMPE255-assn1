# ml-debugging demonstration

## Scenario

**Dataset:** IBM Telco Customer Churn  
**Kaggle:** `https://www.kaggle.com/datasets/blastchar/telco-customer-churn`  
**Objective:** Diagnose suspiciously high validation accuracy and target leakage.
...
3. Execute: Diagnose suspiciously high validation accuracy and target leakage.

# metric-reconciliation demonstration

## Scenario

**Dataset:** A/B Testing  
**Kaggle:** `https://www.kaggle.com/datasets/zhangluyuan/ab-testing`  
**Objective:** Reconcile conversion differences between event and order definitions.

## Acquire

```bash
kaggle datasets download -d datasets/zhangluyuan/ab-testing
```
...
3. Execute: Reconcile conversion differences between event and order definitions.
...
The demonstration uses the dataset for experiment analysis and metric reconciliation. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

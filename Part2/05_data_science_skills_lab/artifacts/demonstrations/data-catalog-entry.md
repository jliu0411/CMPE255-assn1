# data-catalog-entry demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Create governed catalog entries for orders and payment facts.
...
3. Execute: Create governed catalog entries for orders and payment facts.

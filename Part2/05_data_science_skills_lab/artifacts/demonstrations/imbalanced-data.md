# imbalanced-data demonstration

## Scenario

**Dataset:** Credit Card Fraud Detection  
**Kaggle:** `https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud`  
**Objective:** Compare PR-AUC, class weights and threshold costs without naive accuracy.
...
3. Execute: Compare PR-AUC, class weights and threshold costs without naive accuracy.

# query-validation demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Review revenue SQL for join multiplication, grain and refund handling.
...
3. Execute: Review revenue SQL for join multiplication, grain and refund handling.

# analysis-qa-checklist demonstration

## Scenario

**Dataset:** A/B Testing  
**Kaggle:** `https://www.kaggle.com/datasets/zhangluyuan/ab-testing`  
**Objective:** Run pre-delivery statistical, metric and communication checks.
...
3. Execute: Run pre-delivery statistical, metric and communication checks.

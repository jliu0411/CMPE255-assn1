# reproducible-ml demonstration

## Scenario

**Dataset:** Titanic — Machine Learning from Disaster  
**Kaggle:** `https://www.kaggle.com/competitions/titanic`  
**Objective:** Pin environment, data checksum, seeds and deterministic split.
...
3. Execute: Pin environment, data checksum, seeds and deterministic split.

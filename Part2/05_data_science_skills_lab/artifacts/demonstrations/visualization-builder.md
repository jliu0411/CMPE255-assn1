# visualization-builder demonstration

## Scenario

**Dataset:** Netflix Movies and TV Shows  
**Kaggle:** `https://www.kaggle.com/datasets/shivamb/netflix-shows`  
**Objective:** Choose accessible charts for catalog composition and change over time.

## Acquire

```bash
kaggle datasets download -d datasets/shivamb/netflix-shows
```
...
3. Execute: Choose accessible charts for catalog composition and change over time.
...
The demonstration uses the dataset for data storytelling and visualization. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

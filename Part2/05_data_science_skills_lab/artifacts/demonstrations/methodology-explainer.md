# methodology-explainer demonstration

## Scenario

**Dataset:** Mall Customer Segmentation Data  
**Kaggle:** `https://www.kaggle.com/datasets/vjchoudhary7/customer-segmentation-tutorial-in-python`  
**Objective:** Explain clustering validity and limits to nontechnical leadership.
...
3. Execute: Explain clustering validity and limits to nontechnical leadership.

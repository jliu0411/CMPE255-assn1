# root-cause-investigation demonstration

## Scenario

**Dataset:** Rossmann Store Sales  
**Kaggle:** `https://www.kaggle.com/competitions/rossmann-store-sales`  
**Objective:** Decompose a sales decline by store, promotion, holiday and weekday.
...
3. Execute: Decompose a sales decline by store, promotion, holiday and weekday.

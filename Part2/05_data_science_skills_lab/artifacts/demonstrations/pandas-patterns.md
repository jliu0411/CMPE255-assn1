# pandas-patterns demonstration

## Scenario

**Dataset:** Online Retail  
**Kaggle:** `https://www.kaggle.com/datasets/tunguz/online-retail`  
**Objective:** Vectorize invoice cleaning and memory-aware basket aggregation.
...
3. Execute: Vectorize invoice cleaning and memory-aware basket aggregation.

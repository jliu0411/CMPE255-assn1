# programmatic-eda demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Generate schema, missingness, cardinality and anomaly report across tables.
...
3. Execute: Generate schema, missingness, cardinality and anomaly report across tables.

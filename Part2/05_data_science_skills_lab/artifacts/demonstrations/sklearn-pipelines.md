# sklearn-pipelines demonstration

## Scenario

**Dataset:** House Prices: Advanced Regression Techniques  
**Kaggle:** `https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques`  
**Objective:** Package imputation, encoding and regression inside cross-validation.
...
3. Execute: Package imputation, encoding and regression inside cross-validation.

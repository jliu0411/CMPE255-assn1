# context-packager demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Package schema, definitions, assumptions and known issues for handoff.
...
3. Execute: Package schema, definitions, assumptions and known issues for handoff.

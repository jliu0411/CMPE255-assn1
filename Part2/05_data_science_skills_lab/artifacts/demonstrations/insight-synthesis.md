# insight-synthesis demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Prioritize evidence across revenue, delivery, reviews and cohorts.
...
3. Execute: Prioritize evidence across revenue, delivery, reviews and cohorts.

# technical-to-business-translator demonstration

## Scenario

**Dataset:** Credit Card Fraud Detection  
**Kaggle:** `https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud`  
**Objective:** Translate PR-AUC and threshold tradeoffs into review workload and loss.

## Acquire

```bash
kaggle datasets download -d datasets/mlg-ulb/creditcardfraud
```
...
3. Execute: Translate PR-AUC and threshold tradeoffs into review workload and loss.
...
The demonstration uses the dataset for severely imbalanced fraud detection. Raw data remains immutable; derived data and transformations are versioned. Identifiers and sensitive attributes are minimized in outputs.

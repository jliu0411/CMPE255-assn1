# semantic-model-builder demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Define orders, GMV, AOV, delivery SLA and dimensions in a semantic layer.
...
3. Execute: Define orders, GMV, AOV, delivery SLA and dimensions in a semantic layer.

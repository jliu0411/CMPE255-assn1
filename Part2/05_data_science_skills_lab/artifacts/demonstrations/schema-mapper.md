# schema-mapper demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Map orders, items, payments, customers, sellers and reviews at correct grain.
...
3. Execute: Map orders, items, payments, customers, sellers and reviews at correct grain.

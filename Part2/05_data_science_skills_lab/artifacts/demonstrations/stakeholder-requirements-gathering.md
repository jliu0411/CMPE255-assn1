# stakeholder-requirements-gathering demonstration

## Scenario

**Dataset:** Brazilian E-Commerce Public Dataset by Olist  
**Kaggle:** `https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce`  
**Objective:** Elicit decisions, metric definitions, cadence and access needs.
...
3. Execute: Elicit decisions, metric definitions, cadence and access needs.

# ab-test-analysis demonstration

## Scenario

**Dataset:** A/B Testing  
**Kaggle:** `https://www.kaggle.com/datasets/zhangluyuan/ab-testing`  
**Objective:** Estimate uplift, uncertainty, guardrails and practical significance.
...
3. Execute: Estimate uplift, uncertainty, guardrails and practical significance.
